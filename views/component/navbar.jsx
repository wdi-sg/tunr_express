...
class NavBar extends React.Component {
    render() {
        ...
        let logInDisplay;
        if (this.props.loggedIn) { logInDisplay =  <span><a className="nav-item" href="/favorites">Favorites</a> - <a className="nav-item btn btn-outline-primary" href="/logout/">Log Out</a></span>
        } else {

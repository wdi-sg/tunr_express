        ...
        return(
            <nav>
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                    <a method="GET" href="/playlist/new"><span class="glyphicon glyphicon-play" aria-hidden="true"></span>Add a New PlayList</a>
                    </li>
                </ul>
            </nav>
        );
  ...
  render() {
    ...
    return (
      <html>
        ...
        <body>
            <Navigation/>
          <h1>Mildly Comparable Audiophalse (Playlist Set)</h1>
          <div class="content">
            {outList}
          </div>
        </body>

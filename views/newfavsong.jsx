...
class ShowSongs extends React.Component {
	render() {
			...
			return (
				<div class='card col-3 m-2'>
					<div class='card-body'>
						...
						<p class='card-text'>
							From <span className='font-italic'>{element.album}</span>
						</p>
						<a href={element.preview_link} class='btn btn-outline-info btn-block'>
							Listen
						</a>
					</div>
		...
		return (
			<Layout>
				<h1 className='text-center m-3 display-1'>Songs</h1>
				<div class='text-center col-12 d-flex flex-wrap justify-content-center'>{songs}</div>
			</Layout>
		);
	}
}

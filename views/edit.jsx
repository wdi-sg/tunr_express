        ...
        return (
          <div>
            ...
            <form method="POST" action={actionUrl}>
                <p>Name of artist: </p>
                <input name="name" value={this.props.artist[0].name}/>
                <p>Photo URL of artist: </p>
                <input name="url" value={this.props.artist[0].photo_url}/>
                <p>Nationality of artist</p>
                <input name="nationality" value={this.props.artist[0].nationality}/>
                <br/>
                <input type="submit" />
            </form>
          </div>

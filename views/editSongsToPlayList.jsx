...
class songsToPlaylist extends React.Component {
  render() {
    ...
    const url= "/playlist/"+this.props.name[0].id+"?_method=put";
      ...
      <html>
        ...
        <div class={"container border mt-5"}>
            ...
            <div class={"row text-center h-100"}>
                ...
                <h2>Add songs to playlist {this.props.name[0].name}</h2>
                </div>
                ...
                <form method="POST" action={url}  style={{textAlign: "Center"}}>
                         ...
                         <input name="playlist_id" value={this.props.name[0].id} style={{display:"none"}}/>

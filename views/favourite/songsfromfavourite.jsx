...
class AddFavSong extends React.Component{
    render(){
...
class ViewFavSongs extends React.Component {
  render() {
    ...
    return (
      <html>
        ...
        <body>
            <Navigation/>
          <h1>Mildly Comparable Audiophalse (Favourite List)</h1>
          <AddFavSong data={playListId}/>
          <div class="content">
            {outList}
          </div>
        </body>

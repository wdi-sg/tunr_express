        ...
        return (
            ...
            <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
              <div className="navbar-nav">
                ...
                <a className="nav-item nav-link active" href="/playlists">Playlists<span class="sr-only">
                  (current)</span></a>
                  <a className="nav-item nav-link ml-5 text-light btn btn-danger" href="/logout">Logout </a>
                    ...
                    <div className="container-fluid">
                        <h1 className="text-center w-75 ml-auto mr-auto bg-dark text-light"><em><u>Add New Playlist</u></em></h1>
                        <div className="container w-75 ml-auto mr-auto pl-0 pr-0">
                            <br />
                            <form className="card bg-light pl-5 pr-5 pt-5 pb-5" method="POST" action={`/playlists`}>
                                Name:&emsp;
